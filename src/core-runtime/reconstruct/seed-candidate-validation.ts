...
import {
  ...
  RECONSTRUCT_FRONTIER_PRESSURE_ORIGINS as PRESSURE_ORIGINS,
  RECONSTRUCT_FRONTIER_PRESSURE_STATUSES as PRESSURE_STATUSES,
  RECONSTRUCT_FRONTIER_PRESSURE_TYPES as PRESSURE_TYPES,
  RECONSTRUCT_HANDOFF_QUESTION_SOURCES as QUESTION_SOURCES,
  RECONSTRUCT_LOWER_LEVEL_DETAIL_PLACEMENTS as DETAIL_PLACEMENTS,
  ...
  if (seedSchemaVersion === "transitional" || seedSchemaVersion === "concept_centered") {
    ...
    for (const migrationTarget of SEED_MIGRATION_TARGETS) {
      if (
        ...
        migrationTarget.compatibility_status === "transitional_projection"
      ) {
