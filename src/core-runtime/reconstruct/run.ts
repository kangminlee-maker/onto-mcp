  ...
  return {
    ...
    async writeSourcePurposeCandidates(input) {
      ...
      const sourcePurposeSystemPrompt = [
        ...
        "A rejected candidate records a considered-and-excluded alternative for provenance: it must still carry adequacy_frame.frame_id and adequacy_claim, but may leave required_elements empty rather than authoring a full adequacy frame.",
