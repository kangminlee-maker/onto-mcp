...
output_path: .onto/review/20260528-e6edefdf/round1/semantics.md
request_summary: Fresh verification review for the current reconstruct top-level concept discovery design patch after closing material issues from sessions 20260528-391bbc3f, 20260528-da9e31db, 20260528-3d59d774, 20260528-29cea5a1, and 20260528-e8c8b240. Confirm whether material documentation/design-contract issues remain in the current working tree diff, especially answerability question ID uniqueness by declared inventory and status buckets, supported_actions[].supported_by_question_ids[] as the sole canonical question-to-action support edge, lifecycle mapping arrays as the only concept/relation mapping authority, lifecycle.source_snapshot_refs as current source snapshot authority with source_snapshot_transition containing prior refs only, relation_participation_exceptions.status collapsed to isolated, demotion bridge from prior concept IDs to lower-level detail IDs, external migration artifact refs, simplified README and IMPLEMENTATION_MAP authority-reference summaries, source_authority_scope_changed state traceability, lifecycle split/merge continuity, pressure transitions, and answerability references.
...
- materialized input: .onto/review/20260528-e6edefdf/execution-preparation/materialized-input.md
- role definition: .onto/roles/semantics.md
- interpretation: .onto/review/20260528-e6edefdf/interpretation.yaml
- binding: .onto/review/20260528-e6edefdf/binding.yaml
- review target profile: .onto/review/20260528-e6edefdf/execution-preparation/review-target-profile.yaml
- review context manifest: .onto/review/20260528-e6edefdf/execution-preparation/review-context-manifest.yaml
...
## diff-target.patch
ref: /Users/kangmin/cowork/onto-mcp/.onto/review/20260528-e6edefdf/diff-target.patch
...
@@ -58,18 +64,155 @@ registration gate in `reconstruct-boundary-contract.md`.
 |---|---|---|
...
@@ -81,11 +224,12 @@ material-aware source observations
...
+### 5.2 Cluster By Purpose Role
 ...
 declared purpose:
@@ -117,7 +261,7 @@ Example for an AI usage dashboard:
...
@@ -148,214 +292,784 @@ The concept set may be larger when the declared purpose or target bundle is
...
(truncated at 300 lines — full materialized input: .onto/review/20260528-e6edefdf/execution-preparation/materialized-input.md)


## Optional Context Inputs
- session metadata: .onto/review/20260528-e6edefdf/session-metadata.yaml
- target snapshot: .onto/review/20260528-e6edefdf/execution-preparation/target-snapshot.md
- context candidate assembly: .onto/review/20260528-e6edefdf/execution-preparation/context-candidate-assembly.yaml
- domain binding: .onto/review/20260528-e6edefdf/execution-preparation/domain-binding.yaml
- review value-alignment criteria: .onto/review/20260528-e6edefdf/execution-preparation/review-value-alignment-criteria.yaml
- consumer id: lens:semantics
- allowed context source ids: context-candidate-assembly, domain:concepts, domain:prompt_interface, materialized-input, review-target-profile, review-value-alignment-criteria, target-snapshot
...
- allowed output refs:
  - .onto/review/20260528-e6edefdf/round1/logic.md
  - .onto/review/20260528-e6edefdf/round1/structure.md
  - .onto/review/20260528-e6edefdf/round1/dependency.md
  - .onto/review/20260528-e6edefdf/round1/semantics.md
  - .onto/review/20260528-e6edefdf/round1/pragmatics.md
  - .onto/review/20260528-e6edefdf/round1/evolution.md
  - .onto/review/20260528-e6edefdf/round1/coverage.md
  - .onto/review/20260528-e6edefdf/round1/conciseness.md
  - .onto/review/20260528-e6edefdf/round1/axiology.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/logic-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/structure-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/dependency-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/semantics-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/pragmatics-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/evolution-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/coverage-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/conciseness-deliberation.md
  - .onto/review/20260528-e6edefdf/deliberation/round1/axiology-deliberation.md
  - .onto/review/20260528-e6edefdf/finding-ledger.yaml
  - .onto/review/20260528-e6edefdf/finding-relation-graph.yaml
  - .onto/review/20260528-e6edefdf/issue-ledger.yaml
  - .onto/review/20260528-e6edefdf/issue-stance-matrix.yaml
  - .onto/review/20260528-e6edefdf/deliberation-plan.yaml
  - .onto/review/20260528-e6edefdf/problem-framing.yaml
  - .onto/review/20260528-e6edefdf/lens-completion-barrier.yaml
  - .onto/review/20260528-e6edefdf/synthesis.md
  - .onto/review/20260528-e6edefdf/deliberation.md
...
- Write your result to: .onto/review/20260528-e6edefdf/round1/semantics.md
...
- primary: .onto/domains/software-engineering/concepts.md
- supplementary:
