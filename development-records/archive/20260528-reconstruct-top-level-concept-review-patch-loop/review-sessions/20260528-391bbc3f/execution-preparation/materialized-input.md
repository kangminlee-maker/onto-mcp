...
## diff-target.patch
ref: /Users/kangmin/cowork/onto-mcp/.onto/review/20260528-391bbc3f/diff-target.patch
...
@@ -148,214 +284,743 @@ The concept set may be larger when the declared purpose or target bundle is
...
+    - event_id:
+      event_type: created | renamed | split | merged | demoted | boundary_changed
+      concept_ids: []
+      prior_concept_ids: []
+      current_concept_ids: []
+      prior_names: []
...
+- material coverage lifecycle events for source-authority changes, including
+  changed authority field names and prior/current state refs when available
...
@@ -366,22 +1031,41 @@ This contract does not require:
...
+9. Add lifecycle projections for concept and relation identity, provenance,
+   aliasing, split, merge, rename, demotion, and convergence changes.
+10. Add legacy compatibility mapping for `entities`, `relations`, `actions`,
+    `properties`, `rules`, and `claim_id`.
...
+    continuity, material coverage checkpoint presence, and review profile refs
+    when review-confirmed convergence is claimed.
...
index a232c8e..266d7f5 100644
--- a/README.md
+++ b/README.md
@@ -281,7 +281,14 @@ UX expectations in `.onto/processes/reconstruct/reconstruct-execution-ux-contrac
...
+relation participation/direction rules, and legacy compatibility authority for
+the future concept-centered Seed shape.
