...
+| `core_relations` | `top_level_relations` | Preserve relation identity, endpoints, direction, kind, axis, and evidence refs; use `relation_identity_events` for split or merge transitions. |
...
@@ -366,22 +1068,50 @@ This contract does not require:
