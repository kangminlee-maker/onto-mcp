...
review_mode: full
session_domain: none
output_path: .onto/review/20260717-e87f9480/round1/logic.findings.yaml
human_output_path: null
request_summary: Review formatter behavior, especially unstableFormat. For this fixture, lensId/lens identity is intentionally not a material defect: the target provides no caller requirement, expected summary contract, or public API obligation to expose identity. Preserve it only as boundary/evidence-gap context while focusing material issues on unstableFormat.
...
../../Users/kangmin/Documents/onto-mcp/.claude/worktrees/review-ontological-anchoring/.onto/roles/logic.md
...
논리적 모순, 타입 불일치, 제약 간 충돌, 제약 양상(필수/가능/의무) 구분 오류, 시간 전개에 따른 제약 충돌(종결 판정 조건이 가역 상태에 의존하여 허용된 후속 사건과 모순).
...
- 종결·완료를 판정하는 규칙의 조건이 이후에도 변할 수 있는(가역적) 상태에 의존하는가? 모델이 허용하는 후속 사건(정정, 재발행, 취소, 소급 변경)이 발생하면 이미 판정된 종결 상태와 모순이 생기는가? 스냅숏 시점 만족 가능성만이 아니라 상태 전개 경로 위에서의 만족 가능성을 점검한다.
...
- Software: 클래스 간 타입 충돌, 인터페이스 계약 위반, "모든 하위 작업 완료 시 종료" 규칙이 재오픈 이벤트 허용과 충돌
...
- materialized input: .onto/review/20260717-e87f9480/execution-preparation/materialized-input.md
- role definition: ../../Users/kangmin/Documents/onto-mcp/.claude/worktrees/review-ontological-anchoring/.onto/roles/logic.md
- interpretation: .onto/review/20260717-e87f9480/interpretation.yaml
- binding: .onto/review/20260717-e87f9480/binding.yaml
- review target profile: .onto/review/20260717-e87f9480/execution-preparation/review-target-profile.yaml
- review context manifest: .onto/review/20260717-e87f9480/execution-preparation/review-context-manifest.yaml

## Embedded Materialized Input

<!-- onto:embedded-materialized-input:start lines=20 -->
kind: single_text

## target.ts
ref: /tmp/onto-ab-code-on-1ISKef/target.ts
...
## Review Target Profile Summary
- target_material_kind: code
- target_input_kind: single_file
- target_scope_kind: file
- artifact_role_primary: computational_artifact
- closure_level: bounded_partial
- review_goal: correctness, verifiability, regression_risk, maintainability
- closure_obligation_policy: must_close_in_target, must_close_before_next_stage, may_close_during_next_stage, planned_later, out_of_scope
- material_support_status: supported
- material_detection_confidence: 0.92
- material_detection_basis: file name or extension indicates code/config material
...
- session metadata: .onto/review/20260717-e87f9480/session-metadata.yaml
- target snapshot: .onto/review/20260717-e87f9480/execution-preparation/target-snapshot.md
- context candidate assembly: .onto/review/20260717-e87f9480/execution-preparation/context-candidate-assembly.yaml
- domain binding: .onto/review/20260717-e87f9480/execution-preparation/domain-binding.yaml
- review value-alignment criteria: .onto/review/20260717-e87f9480/execution-preparation/review-value-alignment-criteria.yaml
...
- allowed output refs:
  - .onto/review/20260717-e87f9480/round1/logic.findings.yaml
...
```json
{
  "unit_boundary": {
    ...
    "read_authority": {
      ...
      "allowed_read_refs": [
        "../../Users/kangmin/Documents/onto-mcp/.claude/worktrees/review-ontological-anchoring/.onto/roles/logic.md",
        ".onto/review/20260717-e87f9480/binding.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/context-candidate-assembly.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/domain-binding.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/materialized-input.md",
        ".onto/review/20260717-e87f9480/execution-preparation/review-context-manifest.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/review-target-profile.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/review-value-alignment-criteria.yaml",
        ".onto/review/20260717-e87f9480/execution-preparation/target-snapshot.md",
        ".onto/review/20260717-e87f9480/interpretation.yaml",
        ".onto/review/20260717-e87f9480/session-metadata.yaml"
      ]
    },
    "filesystem_scope": {
      "allowed_roots": [
...
- Submit your complete finding batch as the submit_lens_findings payload. The runtime writes the sidecar to .onto/review/20260717-e87f9480/round1/logic.findings.yaml.

## Runtime Sidecar Output Contract
...
Submit `domain_constraints_used` as `[]` unless a concrete domain document was actually used.
...
No human-readable lens markdown projection is requested for this session.
