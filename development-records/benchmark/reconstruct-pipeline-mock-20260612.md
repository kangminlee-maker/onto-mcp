...
> Generated: 2026-06-12T12:01:03.515Z | Commit: eddd52eea (clean tree)
...
|---|---|---|---|---|---|---|
| duration_s | reconstruct-golden-target-v1 | 0.76 | 0.065 | 0.692 | 0.822 | 3 |
| duration_s | reconstruct-golden-target-v2 | 0.705 | 0.024 | 0.678 | 0.722 | 3 |
| total_llm_duration_ms | reconstruct-golden-target-v1 | 0.667 | 0.577 | 0 | 1 | 3 |
| total_llm_duration_ms | reconstruct-golden-target-v2 | 0.667 | 1.155 | 0 | 2 | 3 |
...
|---|---|---|---|---|
| observation_directive | 0.3 | 8691.5 | 178 | 1 |
| lens_judgment | 0.2 | 50076 | 2556 | 9 |
