...
> Status: decision-grade (runs>=3 and fixtures>=2, scored quality evidence present, no quality-evidence rejection)
> Generated: 2026-06-12T11:54:28.577Z | Commit: a99d693e2 (clean tree)
...
|---|---|---|---|---|---|---|
| duration_s | reconstruct-golden-target-v1 | 0.745 | 0.06 | 0.703 | 0.814 | 3 |
| duration_s | reconstruct-golden-target-v2 | 0.716 | 0.019 | 0.7 | 0.737 | 3 |
| total_llm_duration_ms | reconstruct-golden-target-v1 | 1.333 | 2.309 | 0 | 4 | 3 |
| total_llm_duration_ms | reconstruct-golden-target-v2 | 1.333 | 0.577 | 1 | 2 | 3 |
